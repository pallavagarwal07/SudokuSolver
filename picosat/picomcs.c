...
static void cumcs(void) {
    ...
    msg(1, "computed union of minimal correcting sets of size %d with %d mcs", stats[1],
        stats[0]);
}

static void print_umcs(void) {
    int cid;
    printf("v");
...
static void print_all_mcs(void) {
    MCS *p;
